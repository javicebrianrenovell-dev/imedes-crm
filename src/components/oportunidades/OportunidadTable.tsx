...
import { MoreHorizontal, Eye, Pencil, Trash2, Archive, Plus } from 'lucide-react';
...
import { deleteOportunidad, archivarOportunidad } from '@/actions/oportunidades';
                                            ...
                                            <div className="relative">
                                                ...
                                                {openMenuId === op.id && (
                                                    <>
                                                        ...
                                                        <div className="absolute right-0 top-full mt-1 w-44 rounded-lg border border-slate-200 bg-white shadow-lg z-20 py-1 text-sm animate-in-up">
                                                            <Link
                                                                href={`/oportunidades/${op.id}`}
